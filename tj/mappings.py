...
"""
#TODO: inherit from lisa mappings.py and just add the new tables.
...
class T_TRADING_JOURNAL(object):
    """ T_TRADING_JOURNAL """

    #TODO: complete this, after the trading_journal table is finished
    def __init__(self, name, date_created, date_modified):
        self.name = name
        self.date_created = date_created 
        self.date_modified = date_modified
    ...
    def __repr__(self):
        return "<T_TRADING_JOURNAL('%s', '%s', '%s')>" % (self.name, self.date_created, self.date_modified)
