BEGIN;
/* markets */
INSERT INTO T_MARKET(market_id, code, name, country, is_active, date_created, date_modified)
values(1, '', '', '', 1, current_date, current_date);

/* t_account */
INSERT INTO T_ACCOUNT(name, description, is_active, date_created, date_modified)
...
/* commodity type */
INSERT INTO T_COMMODITY_TYPE(name, description, is_active, date_created, date_modified)
...
/* commodity names */
INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, is_active, date_created, date_modified)
