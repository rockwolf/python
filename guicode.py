...
#
# Created: Sun Mar  4 16:38:19 2012
...
class Ui_frm_main(object):
    def setupUi(self, frm_main):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 2, 1181, 611))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(0, 0, 1181, 421))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tbl_summary.sizePolicy().hasHeightForWidth())
        self.tbl_summary.setSizePolicy(sizePolicy)
        ...
        self.lbl_stockname = QtGui.QLabel(self.layoutWidget)
        ...
        self.lbl_marketcode = QtGui.QLabel(self.layoutWidget)
        ...
        self.spn_price = QtGui.QDoubleSpinBox(self.layoutWidget)
        ...
        self.lbl_quantity = QtGui.QLabel(self.layoutWidget)
        ...
        self.cmb_marketcode = QtGui.QComboBox(self.layoutWidget)
        ...
        self.spn_quantity = QtGui.QSpinBox(self.layoutWidget)
        ...
        self.txt_marketdescription = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.lbl_price = QtGui.QLabel(self.layoutWidget)
        ...
        self.cmb_stockname = QtGui.QComboBox(self.layoutWidget)
        ...
        self.spn_commission = QtGui.QDoubleSpinBox(self.layoutWidget)
        ...
        self.lbl_tax = QtGui.QLabel(self.layoutWidget)
        self.lbl_tax.setObjectName(_fromUtf8("lbl_tax"))
        self.gridLayout_4.addWidget(self.lbl_tax, 0, 14, 1, 1)
        self.spn_tax = QtGui.QDoubleSpinBox(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Liberation Mono"))
        ...
        frm_main.setTabOrder(self.spn_amount, self.btn_add)
