...
values('CCZ3.cfd', 'US COCOA, US Dollar DecYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('CTZ3.cfd', 'US Cotton No.2, US Dollar/100 DecYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('KCZ3.cfd', 'US Coffee C, US Dollar/100 DecYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LCCU3.cfd', 'London Cocoa, Pound Sterling SepYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LCCZ3.cfd', 'London Cocoa, Pound Sterling DecYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LEV3.cfd', 'Live Cattle (per 0.01), US Dollar/100 OctYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LRCU3.cfd', 'London Coffee, US Dollar SepYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LRCX3.cfd', 'London Coffee, US Dollar NovYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LSUV3.cfd', 'London Sugar, US Dollar OctYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LSUZ3.cfd', 'London Sugar, US Dollar DecYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LWBX3.cfd', 'London Wheat (per 0.01), Pound Sterling NovYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('OJU3.cfd', 'Orange Juice, US Dollar/100 SepYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('OJX3.cfd', 'Orange Juice, US Dollar/100 NovYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('SBV3.cfd', 'US Sugar No11, US Dollar/100 OctYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('ZVU3.cfd', 'US Corn, US Dollar/100 SepYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('ZCZ3.cfd', 'US Corn, US Dollar/100 DecYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('ZLU3.cfd', 'US Soybean Oil, US Dollar/100 SepYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('ZLV3.cfd', 'US Soybean Oil, US Dollar/100 OctYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('ZSU3.cfd', 'US Soybeans, US Dollar/100 SepYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('ZSX3.cfd', 'US Soybeans, US Dollar/100 NovYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('ZWU3.cfd', 'US Wheat, US Dollar/100 SepYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('ZWZ3.cfd', 'US Wheat, US Dollar/100 DecYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('SBH4.cfd', 'US Sugar No11, US Dollar/100 MarYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LCCH4.cfd', 'London Cocoa Futures, Pound Sterling MarYY', 1, 1, X, current_date, current_date);

-- oil
INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('.BRENT.cfd', 15, 'SPOT Brent Crude Oil, US Dollar/100', 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('.WTI.cfd', 15, 'SPOT WTI Light Crude Oil, US Dollar', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('CLV3.cfd', 15, 'WTI Crude Oil, US Dollar OctYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('CLX3.cfd', 15, 'WTI Crude Oil, US Dollar NovYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('HOU3.cfd', 15, 'Heating Oil, US Dollar NovYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('HOV3.cfd', 15, 'Heating Oil, US Dollar OctYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LCOV3.cfd', 15, 'Brent Crude Oil, US Dollar/100 OctYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LCOX3.cfd', 15, 'Brent Crude Oil, US Dollar/100 NovYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LGOU3.cfd', 15, 'London Gas Oil (per 25), US Dollar/100 SepYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('LGOV3.cfd', 15, 'London Gas Oil (per 25), US Dollar/100 OctYY', 1, 1, X, current_date, current_date);

-- metals
INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('.GOLD.cfd', 13, 'Spot Gold, US Dollar', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('.MGOLD.cfd ', 13, 'MINI Spot Gold, US Dollar', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('.MSILVER.cfd', 14, 'Spot Mini Silver, US Dollar/100', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('.SILVER.cfd', 14, 'Spot Silver, US Dollar/100', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('GCZ3.cfd', 13, 'Gold, US Dollar DecYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('HGU3.cfd ', 'High Grade Copper (per 0.05), US Dollar SepYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('HGZ3.cfd', 'High Grade Copper (per 0.05), US Dollar DecYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('MINISIU3.cfd', 14, 'Mini Silver, US Dollar/100 SepYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('MINISIZ3.cfd ', 14, 'Mini Silver, US Dollar/100 DecYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('PAU3.cfd', 'Palladium, US Dollar SepYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('PAZ3.cfd', 'Palladium, US Dollar DecYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('PLV3.cfd', 'Platinum, US Dollar OctYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('SIU3.cfd', 14, 'Silver, US Dollar/100 SepYY', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('SIZ3.cfd', 14, 'Silver, US Dollar/100 DecYY', 1, 1, X, current_date, current_date);

-- indices
INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('.DE30.cfd', 'Germany 30 cash, Euro', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('.ES35.cfd', 'Spain 35 cash, Euro', 1, 1, X, current_date, current_date);

INSERT INTO T_COMMODITY(name, description, commodity_type_id, cfd_general_id, date_created, date_modified)
values('.F40.cfd ', 'France 40 cash, Euro', 1, 1, X, current_date, current_date);
