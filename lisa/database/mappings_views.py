...
class V_STOCK(object):
    ...
    def __repr__(self):
        return "<V_STOCK('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')>" % (self.finance_id, self.stock_name_id, self.action, self.price, self.shares, self.tax, self.commission, self.historical, self.date_created, self.date_modified, self.risk)
...
class V_STOCK_NAME(object):
    ...
    def __repr__(self):
        return "<V_STOCK_NAME('%s', '%s', '%s', '%s', '%s')>" % (self.name, self.market_id, self.description, self.date_created, self.date_modified)
...
class V_MARKET(object):
    ...
    def __repr__(self):
        return "<V_MARKET('%s', '%s', '%s', '%s', '%s')>" % (self.code, self.name, self.country, self.date_created, self.date_modified)
...
class V_CATEGORY(object):
    ...
    def __repr__(self):
        return "<V_CATEGORY('%s', '%s', '%s', '%s', '%s')>" % (self.subcategory_id, self.name, self.flg_income, self.date_created, self.date_modified)
...
class V_SUBCATEGORY(object):
    ...
    def __repr__(self):
        return "<V_SUBCATEGORY('%s', '%s', '%s')>" % (self.name, self.date_created, self.date_modified)
...
class V_ACCOUNT(object):
    ...
    def __repr__(self):
        return "<V_ACCOUNT('%s', '%s', '%s')>" % (self.name, self.date_created, self.date_modified)
...
class V_CURRENCY(object):
    ...
    def __repr__(self):
        return "<V_CURRENCY('%s', '%s')>" % (self.code, self.description)
...
class V_CURRENCY_EXCHANGE(object):
    ...
    def __repr__(self):
        return "<V_CURRENCY_EXCHANGE('%s', '%s', '%s')>" % (self.currency_id,
