        ...
        for record in inner_part_list:
            ...
            result[1].append(
                {"market_id": record["market_id"]
                 ...
                 ,"shares_buy": record[""]
                 ,"shares_sell": record[""]
                 ,"commission_buy": record[""]
                 ,"commission_sell": record[""]
                 ,"tax_buy": record[""]
                 ,"tax_sell": record[""]
                 ,"amount_buy_simple": record[""]
                 ,"amount_sell_simple": record[""]
                 ,"risk_input": record[""]
                 ,"risk_input_percent": record[""]
                 ,"risk_initial": record[""]
                 ,"risk_initial_percent": record[""]
                 ,"risk_actual": record[""]
                 ,"risk_actual_percent": record[""]
                 ,"cost_total": record[""]
                 ,"cost_other": record[""]
                 ,"stoploss": record[""]
                 ,"profit_loss": record[""]
                 ,"profit_loss_percent": record[""]
                 ,"r_multiple": record[""]
                 ,"win_flag": record[""]
                 ,"id_buy": record[""]
                 ,"id_sell": record[""]
                 ,"currency_exchange_id": record[""]
                 ,"drawdown_id": record[""]
                 ,"pool_at_start": record[""]
                 ,"date_expiration": record[""]
                 ,"expired_flag": record[""]
                 ,"spread": record[""]
                 ,"active": record[""]
